...
const TABLES = {
  ...
  submissions: {
    ...
    columns: [
      ...
      { name: "author_id", type: "uuid", key: "FK", ref: "users.id" },
      { name: "created_at", type: "timestamptz" },
      { name: "updated_at", type: "timestamptz" },
    ],
  },
  ...
  reviewer_assignments: {
    ...
    columns: [
      ...
      { name: "reviewer_id", type: "uuid", key: "FK", ref: "users.id" },
      { name: "assigned_by", type: "uuid", key: "FK", ref: "users.id" },
  ...
  reviews: {
    ...
    columns: [
      { name: "id", type: "uuid", key: "PK" },
      {
        ...
        type: "uuid",
        key: "FK",
        ref: "reviewer_assignments.id",
      },
      { name: "recommendation", type: "review_recommendation" },
      ...
      { name: "released_by", type: "uuid", key: "FK", ref: "users.id" },
  ...
  copy_editor_assignments: {
    ...
    columns: [
      ...
      { name: "copy_editor_id", type: "uuid", key: "FK", ref: "users.id" },
      { name: "assigned_by", type: "uuid", key: "FK", ref: "users.id" },
      { name: "round", type: "integer" },
      { name: "invitation_message", type: "text" },
      { name: "created_at", type: "timestamptz" },
  ...
  activity_log: {
    ...
    columns: [
      ...
      { name: "actor_id", type: "uuid", key: "FK", ref: "users.id" },
      { name: "file_id", type: "uuid", key: "FK", ref: "files.id" },
